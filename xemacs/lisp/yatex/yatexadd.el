...
;;; Last modified Mon Apr 12 12:52:54 2004 on firestorm
			...
			(let*((quit (match-beginning 1))
			  ...
			  (cond
			   ...
			   (t
				...
				;; because formula source is difficult to see
				(progn
				  (goto-char (match-end 0))
...
(defun YaTeX::include (argp &optional prompt)
  (cond
   ((= argp 1)
    (let ((file (read-file-name (or prompt "Input file: ") "")))
